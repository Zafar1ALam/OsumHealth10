        ...
        <SafeAreaView
            ...
            <View style={{
                ...
                <View style={{
                    ...
                    <Text style={STYLES.fontSize17_whiteFFFFFF_Poppins_Bold}>Find & Book</Text>
                        ...
                        renderItem={({ item }) => {
                            return (
                                ...
                                <View style={{
                                    ...
                                    <Text style={STYLES.fontSize14_grey404040_Poppins_SemiBold}>Doctors</Text>
                                    <Text style={STYLES.fontSize10_grey898A8F_Poppins_Regular}>Ophthalmologist, Dermatologist, etc.</Text>
